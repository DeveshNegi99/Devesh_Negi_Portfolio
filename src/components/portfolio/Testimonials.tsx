...
export const Testimonials = () => {
  const testimonials = [
    ...
    {
      Project_name: "-> The Helper Bees",
      role: "Developer, CloudTech Solutions",
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {testimonials.map((testimonial, index) => (
            <Card key={testimonial.Project_name} className="hover:shadow-lg transition-shadow animate-fade-in" style={{ animationDelay: `${index * 0.1}s` }}>
              <CardContent className="pt-6">
                ...
                <div className="border-t pt-4">
                  <div className="font-semibold">{testimonial.Project_name}</div>
